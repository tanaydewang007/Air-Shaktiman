    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans flex flex-col selection:bg-emerald-500 selection:text-slate-950">
      ...
      <header className="bg-slate-900/90 backdrop-blur-md border-b border-slate-800 sticky top-0 z-40 shadow-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              <button
                onClick={() => alert('All CSR verifications & coupon releases are synced and in order!')}
            ...
            <div className="flex items-center space-x-3 border-l pl-3 border-slate-800">
              ...
              <div className="hidden lg:block text-left text-xs">
                ...
                <p className="text-[10px] text-emerald-400 font-semibold">ID: #CORP-982 • Gold Partner</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="md:hidden flex items-center justify-around bg-slate-950 border-t border-slate-800 px-2 py-2 text-[11px] font-bold">
          <button
            onClick={() => setActiveTab('profile')}
            className={`px-2.5 py-1.5 rounded-lg ${activeTab === 'profile' ? 'text-emerald-400 bg-slate-900 font-black' : 'text-slate-400'}`}
          >
            Profile
          </button>
          <button
            onClick={() => setActiveTab('coupons')}
            className={`px-2.5 py-1.5 rounded-lg ${activeTab === 'coupons' ? 'text-emerald-400 bg-slate-900 font-black' : 'text-slate-400'}`}
          >
            Coupons
          </button>
          <button
            onClick={() => setActiveTab('csr')}
            className={`px-2.5 py-1.5 rounded-lg ${activeTab === 'csr' ? 'text-emerald-400 bg-slate-900 font-black' : 'text-slate-400'}`}
          >
            CSR Rank
          </button>
          <button
            onClick={() => setActiveTab('admin-check')}
            className={`px-2.5 py-1.5 rounded-lg ${activeTab === 'admin-check' ? 'text-emerald-400 bg-slate-900 font-black' : 'text-slate-400'}`}
          >
            Admin Check
          </button>
        </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-slate-900/70 border border-slate-800/80 p-5 rounded-2xl flex items-center justify-between shadow-sm">
            <div>
          ...
          <div className="bg-slate-900/70 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-6">
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-500 text-slate-950 flex items-center justify-center font-black text-2xl shadow-lg shadow-emerald-500/20">
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 text-xs px-2.5 py-0.5 rounded-full font-bold flex items-center">
                      <Check className="w-3 h-3 mr-1" /> Verified Partner
                    </span>
                  </div>
              ...
              <button
                ...
                className="px-4 py-2.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-xs font-bold rounded-xl transition flex items-center self-start shadow-lg shadow-emerald-500/20"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 space-y-4">
                <div>
                  ...
                  <p className="text-sm text-slate-300 mt-2 leading-relaxed bg-slate-950/50 p-4 rounded-2xl border border-slate-800/80">
                    {companyInfo.bio}
                  </p>
                </div>
        ...
        {activeTab === 'coupons' && (
          <div className="space-y-6">
            ...
            {/* Point to Voucher Exchange Calculator */}
            ...
            <div className="bg-slate-900/70 rounded-3xl border border-slate-800 overflow-hidden shadow-xl">
                ...
                <table className="w-full text-left text-sm text-slate-300">
                  <thead className="bg-slate-950 text-xs uppercase text-slate-400 font-semibold border-b border-slate-800">
                    <tr>
                      ...
                      <th className="px-6 py-3.5">Points Cost</th>
                      <th className="px-6 py-3.5">Discount Value</th>
                      <th className="px-6 py-3.5">Claimed / Total</th>
            ...
            <div className="bg-slate-900/70 rounded-3xl border border-slate-800 overflow-hidden shadow-xl">
              <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between">
                <h3 className="font-bold text-white flex items-center">
                  <Award className="w-4 h-4 mr-2 text-emerald-400" /> Corporate CSR Standings ({csrScope.toUpperCase()})
                </h3>
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-0.5">{item.stats}</p>
                      </div>
                    </div>
        ...
        {activeTab === 'admin-check' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-slate-900/70 p-4 rounded-2xl border border-slate-800 shadow-sm">
                <div className="flex items-center space-x-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 bg-slate-900/70 rounded-3xl border border-slate-800 p-6 space-y-4 shadow-xl">
                <h3 className="font-bold text-white flex items-center">
              ...
              <div className="bg-slate-900/70 rounded-3xl border border-slate-800 p-6 flex flex-col justify-between shadow-xl">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full text-xs p-3 rounded-2xl bg-slate-950 border border-slate-800 text-white placeholder:text-slate-500 focus:outline-none focus:border-emerald-500"
                  ></textarea>
                </div>
                <button
